...
class Contact
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Adres", mappedBy="contact")
     */
    private $addresses;
     ...
     * Add addresses
     *
     * @param \AppBundle\Entity\Adres $addresses
     * @return Contact
     */
    public function addAddress(\AppBundle\Entity\Adres $addresses)
    {
     ...
     * @param \AppBundle\Entity\Adres $addresses
     */
    public function removeAddress(\AppBundle\Entity\Adres $addresses)
    {
